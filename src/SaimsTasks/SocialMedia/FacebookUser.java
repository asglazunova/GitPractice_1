...
o Direct messaging(String username, String message) - print = %message sent to %username
o Post(String body)
...
public class FacebookUser extends SocialMedia implements  Groups{
    ...
    public void post(String body) {
        allPosts.add(new Post(body)); // making new post object , taking body , and this body sent our tome and data
